...
var ARCHIVOS = [
  ...
  "./voz.js?v=47",
  "./app.js?v=47",
  "./textos-chile.json?v=47",
  "./vendor/pdf.min.js?v=47",
  "./vendor/pdf.worker.min.js?v=47",
  "./vendor/mammoth.browser.min.js?v=47",
  "./vendor/qrcode.js?v=47",
  "./manifest.json",
  "./icons/icon-192.png",
  "./icons/icon-512.png"
];
