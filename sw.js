...
var ARCHIVOS = [
  ...
  "./styles.css?v=45",
  "./app.js?v=45",
  "./textos-chile.json?v=45",
  "./vendor/pdf.min.js?v=45",
  "./vendor/pdf.worker.min.js?v=45",
  "./vendor/mammoth.browser.min.js?v=45",
  "./vendor/qrcode.js?v=45",
  "./manifest.json",
  "./icons/icon-192.png",
  "./icons/icon-512.png"
];
