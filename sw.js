...
var ARCHIVOS = [
  ...
  "./voz.js?v=46",
  "./app.js?v=46",
  "./textos-chile.json?v=46",
  "./vendor/pdf.min.js?v=46",
  "./vendor/pdf.worker.min.js?v=46",
  "./vendor/mammoth.browser.min.js?v=46",
  "./vendor/qrcode.js?v=46",
  "./manifest.json",
  "./icons/icon-192.png",
  "./icons/icon-512.png"
];
